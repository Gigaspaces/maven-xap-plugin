...
---------------------
  ...
  mvn xap:intellij
  If the example is using persistency, then first run Mirror processing unit from IntelliJ -
  select Run > Edit Configurations… Under Application click on Mirror and then press OK then click on Run > Run Mirror.
  Run Processor and then Feeder procssing units in either way you are running with persistency or not -
