...
public class RunPUMojo extends AbstractOpenSpacesMojo {
    ...
    */
    ...
    public static void printUsage() {
        System.out.println("Usage: mvn compile xap:run [-Dcluster=\"...\"] [-Dgroups=<groups>] [-Dlocators=<locators>] [-Dproperties=\"...\"] [-Dmodule=<module name>]");
        ...
        System.out.println("1. -Dcluster=\"schema=partitioned total_members=2,0 id=1\"");
        System.out.println("    - Starts a processing unit with a partitioned cluster schema of two members with instance id 1");
        System.out.println("2. -Dcluster=\"schema=partitioned total_members=2,0 id=2\"");
        System.out.println("    - Starts a processing unit with a partitioned cluster schema of two members with instance id 2");
        System.out.println("3. -Dcluster=\"schema=partitioned total_members=2,1 id=1 backup_id=1\"");
